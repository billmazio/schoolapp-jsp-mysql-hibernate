...
<head>
    ...
    <script src="${pageContext.request.contextPath}/school/static/js/meetingsmenu.js"></script> <!-- Link to your JavaScript file -->
...
<br>
    <br>
                <input name="room" type="text" value="${requestScope.insertedMeeting.room}" class="insert rounded room-input" placeholder="Room: " autofocus  required/>
                <br>
                <input name="meetingDate" type="text" value="${requestScope.insertedMeeting.meetingDate}" class="insert rounded" placeholder="Meeting Date: " autofocus  required/>
                <br>
