...
<head>
    ...
    <script src="${pageContext.request.contextPath}/school/static/js/specialtiesmenu.js"></script> <!-- Link to your JavaScript file -->
    ...
    <div class="insert-wrapper">
        ...
        <div class="bot-gap">
            <form method="POST" action="${pageContext.request.contextPath}/schoolapp/specialtyInsert">
                <input name="name" type="text" value="${requestScope.insertedSpecialty.name}" class="insert rounded" placeholder="Specialty name" autofocus required/><br>
                <br>
